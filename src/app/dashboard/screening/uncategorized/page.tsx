...
export default function Uncategorized() {
  ...
  const [filters, setFilters] = useState<{
    ...
    toDate: "",
    presetTimeFrame: "",
    applicantCategory: location === "FortMyers" ? 'UNCATEGORIZED_FORT_MERYS' : 'UNCATEGORIZED_SARASOTA',
    sortingOptions: "DESC",
  });
  ...
  const clearFilters = () => {
    setFilters({
      ...
      toDate: "",
      presetTimeFrame: "",
      applicantCategory: "UNCATEGORIZED_FORT_MERYS",
      sortingOptions: "DESC",
    });
  ...
  useEffect(() => {
    if (location === "FortMyers") {
      ...
      setFilters((prev) => ({
        ...prev,
        applicantCategory: "UNCATEGORIZED_SARASOTA",
      }));
    }
  }, [searchParams])
